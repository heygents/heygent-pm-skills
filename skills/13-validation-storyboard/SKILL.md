...
- Launches CloakBrowser **headless** at viewport `1440×700` against `--url` with a persistent profile under `~/.cache/heygent-validation-storyboard/<feature>/` (so re-runs stay logged in).
