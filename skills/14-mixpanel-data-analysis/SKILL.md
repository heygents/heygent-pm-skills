...
HeyGent skills can read. It is the numbers-side counterpart to `/01-customer-discovery`
...
Save the investigation as a HeyGent artifact so the rest of the workflow can use it.
