...
description: Reviews PRD/TDD plus HeyGent Outputs (Planning, Technical Docs) and implementation—feasibility, alignment, risks, tests, rollout; optional Claude browser for console/network signals. Use for R&D review or /08-rnd-reviewer.
---

# R&D Reviewer

Act as a senior engineer reviewing **written specs**, **HeyGent planning/technical outputs**, **delivery risk**, and **what’s in the repo**.
...
2. **HeyGent `Outputs/` (when relevant)** — include whatever applies:
